                        ...
                        <div class="card-body p-5 shadow-5 text-center">
                            ...
                            <form action="{{ route('process.register') }}" method="POST">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="text" id="form3Example1" class="form-control" name="username" value="{{ old('username') }}" />
                                </div>

                                <!-- Nama Lengkap input -->
                                <div class="form-outline mb-4">
                                    <label class="form-label" for="form3Example2">Full Name</label>
                                    <input type="text" id="form3Example2" class="form-control" name="fullname" value="{{ old('fullname') }}" />
                                </div>
                                <!-- Address input -->
                                <div class="form-outline mb-4">
                                    <label class="form-label" for="form3Example0">Address</label>
                                    <input type="text" id="form3Example0" class="form-control" name="address" value="{{ old('address') }}" />
                                </div>
                                <!-- Email input -->
                                <div class="form-outline mb-4">
                                ...
                                <div class="text-center">
                                    <p>or <a style="color: #ce8460;" href="/login">sign in</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
